            ...
            <div id="personal-pay" className="mx-auto mb-3">
                ...
                {!error ? <div className="table-content position-relative">
                    ...
                    <div className="table-row font-weight-bold text-light table-row-header">
                        ...
                        <div className="table-cell py-2 px-2 text-center bg-primary">Зарплата</div>
                        ...
                        <div className="table-cell py-2 px-2 text-center bg-primary">Аванс</div>
                    ...
                    <div className="table-row table-row-statistic">
                        ...
                        <div className="table-cell py-1 px-2 text-center">{statistic.oklad || 0}</div>
                        <div className="table-cell py-1 px-2 text-center">{statistic.salary || 0}</div>
                        <div className="table-cell py-1 px-2 text-center">{statistic.fines || 0}</div>
                        <div className="table-cell py-1 px-2 text-center">{statistic.kitchen || 0}</div>
                        <div className="table-cell py-1 px-2 text-center">{statistic.avans || 0}</div>
                        <div className="table-cell py-1 px-2 text-center">{statistic.ostatok || 0}</div>
                    </div>
